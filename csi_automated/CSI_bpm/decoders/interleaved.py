...
class SampleSet(object):
    ...
    def __init__(self, samples, bandwidth, timestamps=None):
...
def read_pcap(pcap_filepath, bandwidth=0, nsamples_max=0):
    ...
    timestamps = np.zeros(nsamples_max, dtype=np.float64)  # Array para armazenar timestamps
    ...
    while ptr < pcap_filesize:
        ...
        timestamps[nsamples] = ts_sec + ts_usec * 1e-6  # Converta para segundos com precisão de microsegundos
